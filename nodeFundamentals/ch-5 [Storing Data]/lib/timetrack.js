...
exports.sendHTML = function (res, html) {
    ...
    res.sendHeader('Content-Length', Buffer.byteLength(html));
}
...
exports.add = function (db, req, res) {
    exports.pareseReceivedData(req, function (work) {
        db.query(
            "INSERT INTO work (hours, date, description)" +
                "VAKUES (?, ?, ?)", [work.hours, work.date, work.description],
            function (err) {
                if (err) throw err;
                exports.show(db, res);
            }
...
exports.workHitListHTML = function (rows) {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        html += '<td>' + exports.workDeletForm(rows[i].id) + '</td>';
        html += '</tr>';
    }
    return html;
};
...
exports.workFormHTML = function () {
    ...
    html += '<p>Date (YYY-MM-DD):<br/><input name="date" type="text" /> </p>';
